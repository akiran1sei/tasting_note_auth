  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = // フォームの入力値をサーバーに送信する
        await fetch(
          `https://tasting-note-no-auth.vercel.app/api/beans/update/${props.singleItem._id}`,
          {
            method: "POST",
            headers: {
      ...
      <>
        ...
        <div className={styles.container}>
          ...
          <main className={styles.main}>
            <div className={styles.contents_shadow}>
              <div className={styles.edit_popup}>
                <div className={styles.edit_box}>
                  <p className={styles.page_title}>ログインしていください。</p>
                </div>
              </div>
            </div>
            ...
            <div className={styles.edit_page}>
              <div className={styles.edit}>
                ...
                <div className={styles.edit_data}>
                  <form className={styles.edit_main}>
                    <input className={styles.edit_date} type="date" />
                    <div className={styles.edit_list}>
                      {/* 選択式 */}
                      <div
                        className={`${styles.edit_item} ${styles.edit_username}`}
                      >
                        <label className={styles.edit_item_title}>作成者</label>
                        <input
                        ...
                        <div className={styles.edit_item_value_box}>
                          ...
                          <div className={styles.edit_item_dry_box}>
                            ...
                            <div className={styles.edit_item_value_box}>
                              ...
                              {/* ドライ （質） */}
                              <p className={styles.edit_item_value}>
                                <label className={styles.edit_item_sub_title}>
                                  （質）
                                </label>
                                <br />
                                <select></select>
                      ...
                      >
                        ...
                        <div className={styles.edit_item_value_box}>
                          ...
                          <input className={styles.edit_input_answer} />
                          <div className={styles.edit_item_message_box}>
                            <label>memo</label>
                            <br />
                            <textarea
                      ...
                      >
                        ...
                        <div className={styles.edit_item_value_box}>
                          <div className={styles.edit_item_value}>
                            ０～８
                            <br />
                            <select className={styles.select_box}></select>
                          </div>
                      ...
                      >
                        ...
                        <div className={styles.edit_result}>
                          ...
                          <div className={styles.edit_addition}>
                            <output className={styles.edit_sub_value}></output>
                    ...
                    <div className={styles.edit_submit_btn_box}>
                      <button className={styles.edit_submit_btn}>
                        作成する
                      </button>
                    </div>
                  </form>
...
export const getServerSideProps = async (context) => {
  const response = await fetch(
    `https://tasting-note-no-auth.vercel.app/api/beans/${context.query.id}`
  );
